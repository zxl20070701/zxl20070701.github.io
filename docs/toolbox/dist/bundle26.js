...
window.__pkg__bundleSrc__['262']=function(){
    ...
    // 简单的饼图
    "pie-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle61.js','263')
    },

    // 多X轴折线图
    "line-multiple-x-axis": function () {
        return window.__pkg__getLazyBundle('./dist/bundle62.js','264')
    },

    // 极坐标下的柱状图
    "bar-polar-real-estate": function () {
        return window.__pkg__getLazyBundle('./dist/bundle63.js','265')
    },

    // 渐变气泡图
    "scatter-bubble-gradient": function () {
        return window.__pkg__getLazyBundle('./dist/bundle64.js','266')
    },

    // 基础K线图
    "candlestick-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle65.js','267')
    },

    // 气压表
    "gauge-barometer": function () {
        return window.__pkg__getLazyBundle('./dist/bundle66.js','268')
    },

    // 旭日图使用视觉编码
    "sunburst-visualMap": function () {
        return window.__pkg__getLazyBundle('./dist/bundle67.js','269')
    },

    // 基础平行坐标
    "parallel-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle68.js','270')
    },

    // 金额波浪球
    "money-schedule": function () {
        return window.__pkg__getLazyBundle('./dist/bundle69.js','271')
    },

    // 水分子式H2O
    "h2o": function () {
        return window.__pkg__getLazyBundle('./dist/bundle70.js','272')
    },

    // 可缩放折线图
    "zoom-line": function () {
        return window.__pkg__getLazyBundle('./dist/bundle71.js','273')
    },

    // 从左到右树状图
    "tree-layout-lr": function () {
        return window.__pkg__getLazyBundle('./dist/bundle72.js','274')
    },

    // 桑基图左对齐布局
    "sankey-nodeAlign-left": function () {
        return window.__pkg__getLazyBundle('./dist/bundle73.js','275')
    },

    // 径向树状图
    "tree-radial": function () {
        return window.__pkg__getLazyBundle('./dist/bundle74.js','276')
    },

    // 单波进度球
    "single-wave": function () {
        return window.__pkg__getLazyBundle('./dist/bundle75.js','277')
    },

    // 水平向下向左树
    "css-tree-topleft": function () {
        return window.__pkg__getLazyBundle('./dist/bundle76.js','278')
    }
};
