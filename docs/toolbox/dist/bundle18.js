...
window.__pkg__bundleSrc__['171']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/bundle48.js','172')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle49.js','173')
    }
...
window.__pkg__bundleSrc__['174']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/bundle50.js','175')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/bundle51.js','176')
    }
