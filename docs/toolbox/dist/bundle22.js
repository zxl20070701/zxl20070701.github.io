...
window.__pkg__bundleSrc__['218']=function(){
    ...
    // 键盘练习
    "keyboard": function () {
        return window.__pkg__getLazyBundle('./dist/bundle57.js','219')
    },

    // 英文打字
    "english": function () {
        return window.__pkg__getLazyBundle('./dist/bundle58.js','220')
    },

    // 拼音打字
    "pinyin": function () {
        return window.__pkg__getLazyBundle('./dist/bundle59.js','221')
    }
};
