...
window.__pkg__bundleSrc__['212']=function(){
    ...
    // 简单的饼图
    "pie-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle52.js','213')
    },

    // 多X轴折线图
    "line-multiple-x-axis": function () {
        return window.__pkg__getLazyBundle('./dist/bundle53.js','214')
    },

    // 极坐标下的柱状图
    "bar-polar-real-estate": function () {
        return window.__pkg__getLazyBundle('./dist/bundle54.js','215')
    },

    // 渐变气泡图
    "scatter-bubble-gradient": function () {
        return window.__pkg__getLazyBundle('./dist/bundle55.js','216')
    },

    // 基础K线图
    "candlestick-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle56.js','217')
    },

    // 气压表
    "gauge-barometer": function () {
        return window.__pkg__getLazyBundle('./dist/bundle57.js','218')
    },

    // 旭日图使用视觉编码
    "sunburst-visualMap": function () {
        return window.__pkg__getLazyBundle('./dist/bundle58.js','219')
    },

    // 基础平行坐标
    "parallel-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle59.js','220')
    },

    // 金额波浪球
    "money-schedule": function () {
        return window.__pkg__getLazyBundle('./dist/bundle60.js','221')
    },

    // 水分子式H2O
    "h2o": function () {
        return window.__pkg__getLazyBundle('./dist/bundle61.js','222')
    },

    // 可缩放折线图
    "zoom-line": function () {
        return window.__pkg__getLazyBundle('./dist/bundle62.js','223')
    },

    // 从左到右树状图
    "tree-layout-lr": function () {
        return window.__pkg__getLazyBundle('./dist/bundle63.js','224')
    },

    // 桑基图左对齐布局
    "sankey-nodeAlign-left": function () {
        return window.__pkg__getLazyBundle('./dist/bundle64.js','225')
    },

    // 径向树状图
    "tree-radial": function () {
        return window.__pkg__getLazyBundle('./dist/bundle65.js','226')
    },

    // 单波进度球
    "single-wave": function () {
        return window.__pkg__getLazyBundle('./dist/bundle66.js','227')
    },

    // 水平向下向左树
    "css-tree-topleft": function () {
        return window.__pkg__getLazyBundle('./dist/bundle67.js','228')
    }
};
