...
window.__pkg__bundleSrc__['190']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/bundle54.js','191')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle55.js','192')
    }
...
window.__pkg__bundleSrc__['193']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/bundle56.js','194')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/bundle57.js','195')
    }
