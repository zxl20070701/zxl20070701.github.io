...
window.__pkg__bundleSrc__['152']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/bundle32.js','153')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle33.js','154')
    }
...
window.__pkg__bundleSrc__['155']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/bundle34.js','156')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/bundle35.js','157')
    }
