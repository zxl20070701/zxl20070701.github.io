...
window.__pkg__bundleSrc__['155']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/bundle35.js','156')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle36.js','157')
    }
...
window.__pkg__bundleSrc__['158']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/bundle37.js','159')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/bundle38.js','160')
    }
