...
window.__pkg__bundleSrc__['161']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/bundle41.js','162')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle42.js','163')
    }
...
window.__pkg__bundleSrc__['164']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/bundle43.js','165')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/bundle44.js','166')
    }
