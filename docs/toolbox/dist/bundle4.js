...
window.__pkg__bundleSrc__['61']=function(){
    var __pkg__scope_bundle__={};
    var __pkg__scope_args__;
    __pkg__scope_bundle__.default= [{"type":"tag","name":"root","attrs":{},"childNodes":[1,6]},{"type":"tag","name":"ul","attrs":{"class":"content","ui-right-menu:system":"","ui-on:click":"doSelect","tag":""},"childNodes":[2,4]},{"type":"tag","name":"li","attrs":{"class":"link","ui-bind:select":"select=='regexper-visualization'?'yes':'no'","ui-on:click.stop":"doSelect","title":"输入一个正则表达式后可以把其变成可视化的图表来快速读懂意义","tag":"regexper-visualization","ui-on:dblclick":"goto","ui-right-menu:app":""},"childNodes":[3]},{"type":"text","content":"正则表达式可视化","childNodes":[]},{"type":"tag","name":"li","attrs":{"class":"link","ui-bind:select":"select=='recorder-screen'?'yes':'no'","ui-on:click.stop":"doSelect","title":"一个H5版本的电脑屏幕录制软件","tag":"recorder-screen","ui-on:dblclick":"goto","ui-right-menu:app":""},"childNodes":[5]},{"type":"text","content":"录屏软件","childNodes":[]},{"type":"tag","name":"div","attrs":{"class":"taskline","ui-right-menu:desktop-line":""},"childNodes":[7,8,9,10]},{"type":"tag","name":"span","attrs":{"class":"begin","title":"快速开始","tag":"begin","ui-on:click.stop":"toggleWin"},"childNodes":[]},{"type":"tag","name":"span","attrs":{"class":"what","tag":"what","ui-on:click":"openDialog"},"childNodes":[]},{"type":"tag","name":"span","attrs":{"class":"wins","id":"wins-line-id"},"childNodes":[]},{"type":"tag","name":"span","attrs":{"class":"time","tag":"tools","ui-on:click.stop":"toggleWin"},"childNodes":[11,12]},{"type":"tag","name":"div","attrs":{"ui-bind":"time"},"childNodes":[]},{"type":"tag","name":"div","attrs":{"ui-bind":"date"},"childNodes":[]}]
...
window.__pkg__bundleSrc__['63']=function(){
    ...
    // 快速开始
    begin: function () {
        return window.__pkg__getLazyBundle('./dist/bundle10.js','64')
    },
