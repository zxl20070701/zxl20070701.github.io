...
window.__pkg__bundleSrc__['183']=function(){
    ...
    // 简单的饼图
    "pie-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle33.js','184')
    },

    // 多X轴折线图
    "line-multiple-x-axis": function () {
        return window.__pkg__getLazyBundle('./dist/bundle34.js','185')
    },

    // 极坐标下的柱状图
    "bar-polar-real-estate": function () {
        return window.__pkg__getLazyBundle('./dist/bundle35.js','186')
    },

    // 渐变气泡图
    "scatter-bubble-gradient": function () {
        return window.__pkg__getLazyBundle('./dist/bundle36.js','187')
    },

    // 基础K线图
    "candlestick-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle37.js','188')
    },

    // 气压表
    "gauge-barometer": function () {
        return window.__pkg__getLazyBundle('./dist/bundle38.js','189')
    },

    // 旭日图使用视觉编码
    "sunburst-visualMap": function () {
        return window.__pkg__getLazyBundle('./dist/bundle39.js','190')
    },

    // 基础平行坐标
    "parallel-simple": function () {
        return window.__pkg__getLazyBundle('./dist/bundle40.js','191')
    },

    // 金额波浪球
    "money-schedule": function () {
        return window.__pkg__getLazyBundle('./dist/bundle41.js','192')
    },

    // 水分子式H2O
    "h2o": function () {
        return window.__pkg__getLazyBundle('./dist/bundle42.js','193')
    },

    // 可缩放折线图
    "zoom-line": function () {
        return window.__pkg__getLazyBundle('./dist/bundle43.js','194')
    },

    // 从左到右树状图
    "tree-layout-lr": function () {
        return window.__pkg__getLazyBundle('./dist/bundle44.js','195')
    },

    // 桑基图左对齐布局
    "sankey-nodeAlign-left": function () {
        return window.__pkg__getLazyBundle('./dist/bundle45.js','196')
    },

    // 径向树状图
    "tree-radial": function () {
        return window.__pkg__getLazyBundle('./dist/bundle46.js','197')
    },

    // 单波进度球
    "single-wave": function () {
        return window.__pkg__getLazyBundle('./dist/bundle47.js','198')
    },

    // 水平向下向左树
    "css-tree-topleft": function () {
        return window.__pkg__getLazyBundle('./dist/bundle48.js','199')
    }
};
