...
window.__pkg__bundleSrc__['135']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/bundle22.js','136')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle23.js','137')
    }
...
window.__pkg__bundleSrc__['138']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/bundle24.js','139')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/bundle25.js','140')
    }
