...
window.__pkg__bundleSrc__['133']=function(){
    ...
    // 画布或图像大小
    size: function () {
        return window.__pkg__getLazyBundle('./dist/bundle20.js','134')
    },

    // 保存
    save: function () {
        return window.__pkg__getLazyBundle('./dist/bundle21.js','135')
    }
...
window.__pkg__bundleSrc__['136']=function(){
    ...
    // 工具箱
    tool: function () {
        return window.__pkg__getLazyBundle('./dist/bundle22.js','137')
    },

    // 图层
    layer: function () {
        return window.__pkg__getLazyBundle('./dist/bundle23.js','138')
    }
