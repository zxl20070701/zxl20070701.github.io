...
window.__pkg__bundleSrc__['280']=function(){
    var __pkg__scope_bundle__={};
    var __pkg__scope_args__;
    __pkg__scope_bundle__.default= [{"type":"tag","name":"root","attrs":{},"childNodes":[1,9]},{"type":"tag","name":"header","attrs":{"ui-dragdrop:desktop":""},"childNodes":[2,4]},{"type":"tag","name":"h2","attrs":{},"childNodes":[3]},{"type":"text","content":"金山打字通","childNodes":[]},{"type":"tag","name":"div","attrs":{"class":"win-btns"},"childNodes":[5,7]},{"type":"tag","name":"button","attrs":{"class":"min","ui-on:click.stop":"$minView"},"childNodes":[6]},{"type":"text","content":"最小化","childNodes":[]},{"type":"tag","name":"button","attrs":{"class":"close","ui-on:click.stop":"$closeView"},"childNodes":[8]},{"type":"text","content":"关闭","childNodes":[]},{"type":"tag","name":"div","attrs":{"class":"content"},"childNodes":[10,12,14]},{"type":"tag","name":"span","attrs":{"class":"keyboard btn","ui-on:click":"openPage","tag":"keyboard"},"childNodes":[11]},{"type":"text","content":"键盘练习","childNodes":[]},{"type":"tag","name":"span","attrs":{"class":"english btn","ui-on:click":"openPage","tag":"english"},"childNodes":[13]},{"type":"text","content":"英文打字","childNodes":[]},{"type":"tag","name":"span","attrs":{"class":"pinyin btn","ui-on:click":"openPage","tag":"pinyin"},"childNodes":[15]},{"type":"text","content":"拼音打字","childNodes":[]}]
...
window.__pkg__bundleSrc__['283']=function(){
    ...
    // 键盘练习
    "keyboard": function () {
        return window.__pkg__getLazyBundle('./dist/bundle78.js','284')
    },

    // 英文打字
    "english": function () {
        return window.__pkg__getLazyBundle('./dist/bundle79.js','285')
    },

    // 拼音打字
    "pinyin": function () {
        return window.__pkg__getLazyBundle('./dist/bundle80.js','286')
    }
};
