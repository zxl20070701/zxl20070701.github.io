...
window.__pkg__bundleSrc__['121']=function(){
    ...
    // 内置框架
    framework: function () {
        return window.__pkg__getLazyBundle('./dist/bundle46.js','122')
    },

    // 代码编辑器
    editor: function () {
        return window.__pkg__getLazyBundle('./dist/bundle47.js','123')
    },

    // WebGL
    webgl: function () {
        return window.__pkg__getLazyBundle('./dist/bundle48.js','124')
    },

    // canvas
    canvas: function () {
        return window.__pkg__getLazyBundle('./dist/bundle49.js','125')
    },

    // 颜色选择器
    "color-picker": function () {
        return window.__pkg__getLazyBundle('./dist/bundle50.js','126')
    },

    // svg
    svg: function () {
        return window.__pkg__getLazyBundle('./dist/bundle51.js','127')
    }
};
