...
/*************************** [bundle] ****************************/
// Original file:./src/directives/ui-dragdrop
/*****************************************************************/
...
window.__pkg__bundleSrc__['22']=function(){
    ...
    // 首页
    home: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle1.js','23')
    },

    // 正则表达式可视化
    "regexper-visualization": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle2.js','24')
    },

    // 音频编辑器
    "audio-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle3.js','25')
    },

    // 格式化JSON字符串
    "format-json": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle4.js','26')
    },

    // 图片编辑器
    "image-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle5.js','27')
    },

    // 模型编辑器
    "model-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle6.js','28')
    },

    // 视频播放器
    "video-play": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle7.js','29')
    },

    // 贪吃蛇
    "snake-eating": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle8.js','30')
    },

    // scss转css
    scss: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle9.js','31')
    },

    // 代码编辑器
    "code-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle10.js','32')
    },
};
...
window.__pkg__bundleSrc__['33']=function(){
    ...
    // 调试
    debugger: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle11.js','34')
    },

    // 颜色选择
    "color-picker": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.3-bundle12.js','35')
    }
