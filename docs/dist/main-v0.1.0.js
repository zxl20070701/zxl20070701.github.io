...
window.__pkg__bundleSrc__['20']=function(){
    ...
    // 首页
    home: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle1.js','21')
    },

    // 正则表达式可视化
    "regexper-visualization": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle2.js','22')
    },

    // 音频编辑器
    "audio-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle3.js','23')
    }
