...
window.__pkg__bundleSrc__['25']=function(){
    ...
    // 首页
    home: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle1.js','26')
    },

    // 正则表达式可视化
    "regexper-visualization": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle2.js','27')
    },

    // 音频编辑器
    "audio-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle3.js','28')
    },

    // 格式化JSON字符串
    "format-json": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle4.js','29')
    },

    // 图片编辑器
    "image-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle5.js','30')
    },

    // 模型编辑器
    "model-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle6.js','31')
    },

    // 贪吃蛇
    "snake-eating": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle7.js','32')
    },

    // scss转css
    scss: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle8.js','33')
    },

    // 代码编辑器
    "code-editor": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle9.js','34')
    },

    // npm download
    "npm-download": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle10.js','35')
    }
};
...
window.__pkg__bundleSrc__['36']=function(){
    ...
    // 调试
    debugger: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle11.js','37')
    },

    // 颜色选择
    "color-picker": function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle12.js','38')
    },

    // 接口文档
    api: function () {
        return window.__pkg__getLazyBundle('./dist/main-v0.1.0-bundle13.js','39')
    }
